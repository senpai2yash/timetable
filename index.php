    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="../finalproject/admin/index.php" style='color:red'>Admin</a></li>
          <li><a href="../finalproject/staff/index.php" style='color:orange'>Staff</a></li>
          <li><a href="../finalproject/student/index.php" style='color:green'>Student</a></li>
        </ul>
      </li> 
    </ul>
  </div>
       ...
       <!--contact-->
            <br/><br/>
             ...
             <h2 class="section-heading" align="center">Contact Us</h2>
                        <hr class="primary">
                <div class="col-lg-offset-2 col-lg-8 text-center" style="padding-top:20px">
...
if(isset($save)) {
    ...
    $result = mysqli_query($con, "SELECT * FROM contactus WHERE email = '$e'");
    if(mysqli_num_rows($result) > 0) {
        $err = "<font color='blue'>Name or Email already exists!</font>";
    } else {
        // Insert the new record if the email doesn't exist
        mysqli_query($con, "INSERT INTO contactus VALUES('', '$name', '$e', '$s', '$m')");
        $err = "<font color='yellow'>Congrats! Your Data Saved!</font>";
    }
}
...
?>
 ...
 <?php echo @$err; ?>
    ...
    <div class="row" style="margin-bottom: 10px;margin-left:523px">
        <input type="submit" value="save" name="save" class="btn btn-success" style="border-radius:5px;" />
    </div>
    </form>
    <div class="row" style="margin-bottom: 10px;">
    </div>
...
if(isset($save)) {
    $que = mysqli_query($con,"SELECT * FROM student WHERE eid='$eid'");
    $row = mysqli_num_rows($que);
    if($row > 0) {
        $err = "<font color='blue'>This user already exists</font>";
    } else {
...
<?php echo @$err; ?>
   ...
   <div class="row" style="margin-bottom: 10px;">
    ...
    <div class="row" style="margin-bottom: 10px;">
    <label style="margin-right: 10px;color:antiquewhite">Gender:</label>
    <label for="male" style="margin-right: 10px;"><input type="radio" value="m" id="male" name="gen"> Male</label>
    <label for="female"><input type="radio" value="f" id="female" name="gen"> Female</label>
</div>
