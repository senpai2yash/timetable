...
<div class="col-md-5"> 
               ...
               <h2><font color="black">Update Password</font></h2>
<form method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <th width="237" scope="row"><font color="black" >Old Password</font> </th>
    <td width="213"><input type="text" name="op" class="form-control" value="<?php echo $res['password'];?>"/></td>
  </tr>
  
  <tr>
    <th width="237" scope="row"><font color="black" >New Password </font></th>
    <td width="213"><input type="password" name="np" class="form-control" value="<?php echo $np; ?>"/></td>
  </tr>
  
  <tr>
    <th width="237" scope="row"><font color="black" >Confirm Password</font> </th>
